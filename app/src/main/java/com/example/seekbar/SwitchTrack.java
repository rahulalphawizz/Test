 ...
 */
public class SwitchTrack extends Drawable {
    ...
    public SwitchTrack(@NonNull Context context,
                                    String leftTextId,
                                    String rightTextId) {
        mContext = context;

        // Left text
        mLeftText = leftTextId;//context.getString(leftTextId);
        mTextPaint = createTextPaint();

        // Right text
        mRightText = rightTextId;// context.getString(rightTextId);
    }
